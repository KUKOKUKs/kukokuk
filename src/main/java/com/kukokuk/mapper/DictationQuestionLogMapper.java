...
public interface DictationQuestionLogMapper {
     ...
     */
    void updateHintUsed(@Param("dictationQuestionLogNo") int dictationQuestionLogNo,
     ...
     */
    void updateIsSuccess(@Param("dictationQuestionLogNo") int dictationQuestionLogNo,

...
public class DictationService {
   ...
   *     session.setStartDate(0);
   *     dictationSessionMapper.insertDictationSession(session);
   *
   *   // 기존 DB 저장된 문제 랜덤 10개 가져오기
   *   List<DictationQuestion> randomQuestions = dictationQuestionMapper.getRandomQuestions();
   *
   *   // 받아쓰기 문제 풀이 이력과 연결(DictationSessionNo으로 문제 가져오기)
  ...
  /*
    받아쓰기 끝났을 때 받아쓰기 문제 세트 정답 점수, 맞은 개수, 사용한 힌트 수 업데이트
   */

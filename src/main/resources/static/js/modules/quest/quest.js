import {getDailyQuestList} from "./quest-api.js";
...
$(document).ready(async function () {
    ...
    async function setDailyQuestList() {
        ...
        const dailyQuestList = await getDailyQuestList(isLoggedIn);
                ...
                <div class="component_info small with_icon">
                    <div class="list_info">
                        ...
                        <div class="bar_gauge">
                            ...
                            <span class="gauge_info">${progressValue} / ${totalScore}</span>
                        </div>
                    </div>
                    
                    ${isSucceed // 퀘스트 완료
                        ? isObtained // 보상 수령 완료
                            ? `<span class="btn small white disabled"><img th:src="@{/images/favicon-32x32.png/}" alt="hint obtained"></span>`
                            : `<button type="button" data-daily-quest-user-no="${quest.dailyQuestUserNo}" class="btn small white get_hint_btn">
                                    <img th:src="@{/images/favicon-32x32.png/}" alt="get hints">
                                </button>`

...
$(document).ready(async () => {
    ...
    const requestRows = groupStudyRows > 5 ? groupStudyRows : 5; // 기본 요청 데이터 개수는 컨트롤러 기본 값 5
    ...
    if ($groupStudyListContainer.length) {
        await renderFragmentDailyStudies(groupStudyRows, requestRows, $groupStudyListContainer, isUseSpinner); // 실행
    }
})